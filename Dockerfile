...
# Shell commands that are ran inside containers to build the image
...
# Change current working directiory inside the image
WORKDIR /usr/src/app
...
# Declare that port 80 is a port open by this container
EXPOSE 80
